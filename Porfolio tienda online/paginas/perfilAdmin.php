                ...
                <div class="col-12 col-md-8 col-lg-6">
                    <div class="perfil p-4 shadow-lg rounded text-center">
                        ...
                        <div class="foto mb-3">
                            ...
                            <br>
                            <a href="../cambioDatosPerfil/cambiarFotoAdmin.php?id_user=<?php echo $usuario; ?>" 
   class="btn btn-info">
    <img src="../img/iconoLapiz.svg" alt="Cambiar foto" width="20" height="20"> Cambiar foto
                        ...
                        <a href="../cambioDatosPerfil/editarUsuarioAdmin.php?id_user=<?php echo $usuario; ?>" 
   class="btn btn-warning">
    <img src="../img/iconoLapiz.svg" alt="Editar" width="20" height="20"> Editar usuario
</a>
...
<a href="../cambioDatosPerfil/eliminarUsuario.php?id_user=<?php echo $usuario; ?>" 
   ...
   onclick="return confirm('¿Estás seguro de que quieres eliminar este usuario? Esta acción no se puede deshacer.');">
    <img src="../img/iconoPapelera.svg" alt="Eliminar" width="20" height="20"> Eliminar usuario
</a>
                        </div>
                    </div>
                </div>
